...
if __name__ == "__main__":
    ...
    env = sumo_rl.gangnam(use_gui=False, out_csv_name="outputs/Gangnam/ppo_test", virtual_display=RESOLUTION)
    ...
    env = ss.concat_vec_envs_v1(env, 2, num_cpus=32, base_class="stable_baselines3")
    env = VecMonitor(env)
    ...
    model = PPO(
        ...
        clip_range=0.3,
        batch_size=256,
        tensorboard_log="./logs/Gangnam/ppo_test",
    )
