...
def grid4x4(parallel=True, **kwargs):
    ...
    kwargs.update(
        {
            "net_file": "C:/Users/skang/signal/sumo-rl/nets/RESCO/grid4x4/grid4x4.net.xml",
            "route_file": "C:/Users/skang/signal/sumo-rl/nets/RESCO/grid4x4/grid4x4_1.rou.xml",
            "num_seconds": 3600,
        }
    )
    if parallel:
...
def gangnam(parallel=True, **kwargs):

    kwargs.update(
        {
            "net_file": PATH + "/../nets/Gangnam/gangnam.net.xml",
            "route_file": PATH + "/../nets/Gangnam/gangnam.rou.xml",
            "num_seconds": 21600,
        }
    )
    if parallel:
